...
"zoo"
    ...
    public GameObject[] seed_phrase;
    public GameObject[] randomize_seed_phrase;
    public Text _pubKey;
    public Wallet _web3;
    public GameObject _cover;
    public GameObject _seedA;
    public GameObject _seedB;
    public Text _verificationBox;
    ...
    public void verifySelection(Button button)
    {
        Debug.Log(button.name);
        Debug.Log(button.GetComponentInChildren<Text>().text);
        Debug.Log(seed_phrase[onIndex].GetComponentInChildren<Text>().text.Split(":")[1].Replace(" ",""));

        if(button.GetComponentInChildren<Text>().text == seed_phrase[onIndex].GetComponentInChildren<Text>().text.Split(":")[1].Replace(" ", ""))
        {
            button.gameObject.SetActive(false);
            _verificationBox.text = _verificationBox.text + " " + button.GetComponentInChildren<Text>().text;
            onIndex++;
    ...
    //User Initiated Request to Copy
    public void CopyToClipboard()
    {
        string copy_format = _pubKey.text + "\n\n DONT SHARE YOUR MNEMONIC WORDS \n" + "mnemonic: " + mnemonic_string;
        GUIUtility.systemCopyBuffer = copy_format;
        

    }


    public void GenNewWallet()
    {
        ...
        for (int i = 0; i < 12; i++)
        {
            ...
            seed_phrase[i].GetComponentInChildren<Text>().text = i.ToString() + ": " + bip39_2022[Convert.ToInt32(entrapy.Substring(z, 11), 2)];
        ...
        _pubKey.text = "PublicKey: "+_web3.GetPublicKey(mnemonic_string);


        //foreach (var item in mnemonicArray)
        //{
        //    Debug.Log(item);
        ...
        for (int i = 0; i < 12; i++)
        {
            randomize_seed_phrase[i].GetComponentInChildren<Text>().text = arr[i];
        }
    ...
    public void Next()
    {
        _seedA.SetActive(false);
        _seedB.SetActive(true);
    }
