...
public class Wallet : MonoBehaviour
{
    ...
    byte[] feePayer_sK;
    byte[] feePayer_pK;
    public string[] feePayer_mN;
    public string feePayer_base58;
    ...
    Keypair feePayer_kP = new Keypair();
...
"zoo"
    ...
    {
        feePayer_kP = GenerateKeyPair();
        feePayer_pK = feePayer_kP.PublicKey;
        feePayer_sK = feePayer_kP.SecretKey;
        feePayer_mN = feePayer_kP.mnemonic;
        feePayer_base58 = feePayer_kP.PublicKeyBase58;
    ...
    void metaMint()
    {
        ...
        feePayer_sK = GetSkFromMnemonic(string.Join(" ",feePayer_mN));
        ...
        //23 Candy Machine Creator - DYNAMIC
        ...
        using (UnityWebRequest www = UnityWebRequest.Post(url, postData))
        {
            ...
            else
            {
                ...
                if (postData.ToString().Contains("getSignatureStatuses"))
                {
                    ...
                    Application.OpenURL("https://explorer.solana.com/tx/"+txSignature+ "?cluster=devnet");
